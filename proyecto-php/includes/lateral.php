<!--Barra Lateral -->
			<aside id="sidebar">
				...
				<div id="usuario-logueado" class="bloque">
					...
					<div class="buttones">
					<a class="btn btn-outline-primary d-block" href="crear-categoria.php" target="new">Crear Categoria</a>
					
					<br>
					<a class="btn btn-outline-info d-block" href="#.php">Mis Datos</a>
					<br>

					<a class="btn btn-outline-secondary d-block" href="#.php">Crear entrada </a>	
